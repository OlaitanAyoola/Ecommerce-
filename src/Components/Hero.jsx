...
const Hero = () => {
    return (
        ...
        <div class=" mx-auto p-6  bg-gradient-to-br from-indigo-900 to-green-900 md:px-14 py-8 ">
          <div class="w-full  text-center mx-auto md:text-center">
            <h1 class="mt-32 text-white text-6xl font-bold">The fastest, most secure development environment <br /><span class="text-blue-400">on the planet.</span></h1>
          </div>
          <div class="w-5/6 p-6 mx-auto md:p-14">
